/**
 * Honey Bokeh Lips Visualizer - ENHANCED IMPLEMENTATION
 * Builds a particle mouth silhouette from a mask image and reacts to speech.
 * Features: lazy init, performance modes, glyph atlas, frame-driven amplitude on high-perf devices
 */
...
const BeeSwarmVisualizer = {
  init(container, options = {}) {
    ...
    const opts = {
      ...
      // Use the in-repo visualizer mask (clean2 = solid filled lip mask) for sampling
      maskUrl: '/static/assets/visualizer/lips_mask_clean2.png',
      sampleStep: 3,
