...
- Bundle Identifier: `app.beesmartspelling`
...
- AppIcon.appiconset: ensure 1024×1024 source present (AppIcon-512@2x.png)
...
- Create app record with bundle ID `app.beesmartspelling`
