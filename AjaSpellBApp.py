...
INAPPROPRIATE_WORDS = {
    ...
    "screw", "screwed", "screwing",  # when used as vulgar
    ...
    "lust", "lustful", "lusty",
    "fetish", "fetishes", "pervert", "perverts", "perverted", "perverted",
    ...
    "knife", "knives",  # in violent context—caught by partial match
    ...
    "beer", "liquor", "whiskey", "vodka", "tequila",  # age-inappropriate for kids
    ...
    "gook", "gooks",
    "wetback", "wetbacks",
    "cracker",  # racial slur context
    "honky", "honkies",
    "fag", "fags", "faggot", "faggots",
    "dyke", "dykes",  # used as slur
    ...
    "necrophilia",
    "self-harm", "selfharm", "cutting",  # self-harm context
