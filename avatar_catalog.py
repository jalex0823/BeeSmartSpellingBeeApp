...
AVATAR_CATALOG: List[Dict] = [
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "A peaceful little bee who loves calm vibes, focus, and mindful spelling moments.",
        "variants": ["default"],
        "category": "spiritual",
        "tier": "premium",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Always pumped and ready to go — Buzz Bee brings energy to every spelling challenge!",
        "variants": ["default"],
        "category": "classic",
        "tier": "earn_or_buy",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Shades on. Chill mode activated. Cool Bee is smooth, stylish, and full of confidence.",
        "variants": ["default"],
        "category": "classic",
        "tier": "default_free",
        "is_default_free": True,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Adorable and sweet — Cutie Bee is guaranteed to make every game session extra fun.",
        "variants": ["default"],
        "category": "cute",
        "tier": "earn_or_buy",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Dr. Bee is always here to help! Clipboard ready, cheering you on as you learn new words.",
        "variants": ["default"],
        "category": "profession",
        "tier": "premium",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Sweet, golden, and iconic — Honey Comb Bee represents pure BeeSmart pride.",
        "variants": ["default"],
        "category": "classic",
        "tier": "premium",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Ready to rock n' roll! Guitar in hand, J Rock Bee brings rhythm to your spelling.",
        "variants": ["default"],
        "category": "entertainment",
        "tier": "premium",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Brave and bold — Knight Bee protects your spelling kingdom with honor!",
        "variants": ["default"],
        "category": "fantasy",
        "tier": "earn_or_buy",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Royal, radiant, and full of leadership — Queen Bee rules the spelling hive!",
        "variants": ["default"],
        "category": "royal",
        "tier": "premium",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Bzz-bzz-beep! Robo Bee is a high-tech helper built for spelling greatness.",
        "variants": ["default"],
        "category": "tech",
        "tier": "premium",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "A deep-sea explorer bee who loves ocean adventures and cool blue vibes.",
        "variants": ["default"],
        "category": "adventure",
        "tier": "premium",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Smile! Selfie Bee loves photos, fun, and capturing your spelling victories.",
        "variants": ["default"],
        "category": "entertainment",
        "tier": "earn_or_buy",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Fast and focused, Motor Bee zooms into action and powers up your learning.",
        "variants": ["default"],
        "category": "action",
        "tier": "premium",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "A classic BeeSmart sidekick — O Bee keeps things simple, fun, and full of charm.",
        "variants": ["default"],
        "category": "fantasy",
        "tier": "premium",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Microphone ready — Singer Bee hits every high note as you hit every correct word!",
        "variants": ["default"],
        "category": "entertainment",
        "tier": "premium",
        "is_default_free": False,
...
ADDITIONAL_AVATARS: List[Dict] = [
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Out-of-this-world awesome! Space Bee is ready for spelling missions across the galaxy.",
        "variants": ["default"],
        "category": "adventure",
        "tier": "premium",
        "is_default_free": False,
    ...
    },
    {
        ...
        "mtl_file": "",
        "texture_file": "",
        "description": "Strong, bold, and heroic — Super Bee saves the day when learning gets tough!",
        "variants": ["default"],
        "category": "fantasy",
        "tier": "premium",
        "is_default_free": False,
    ...
    {
        "id": "gamer-bee",
        "product_id": "beesmart.avatar.gamer_bee",
        "name": "Gamer Bee Avatar",
        "folder": "glb_files",
        "obj_file": "GamerBee.glb",
        "mtl_file": "",
        "texture_file": "",
        "description": "Headset on and controller ready — Gamer Bee is locked in for spelling victory!",
        "variants": ["default"],
        "category": "classic",
        "tier": "premium",
        "is_default_free": False,
    ...
    {
        "id": "inventor-bee",
        "product_id": "beesmart.avatar.inventor_bee",
        "name": "Inventor Bee Avatar",
        "folder": "glb_files",
        "obj_file": "InventorBee.glb",
        "mtl_file": "",
        "texture_file": "",
        "description": "A brilliant spark-powered genius — Inventor Bee creates buzzing new ideas with electricity!",
        "variants": ["default"],
        "category": "adventure",
        "tier": "premium",
        "is_default_free": False,
    ...
    {
        "id": "lumberjack-bee",
        "product_id": "beesmart.avatar.lumberjack_bee",
        "name": "Lumberjack Bee Avatar",
        "folder": "glb_files",
        "obj_file": "LumberjackBee.glb",
        "mtl_file": "",
        "texture_file": "",
        "description": "Strong, brave, and outdoorsy — Lumberjack Bee chops through tough spelling challenges!",
        "variants": ["default"],
        "category": "adventure",
        "tier": "premium",
        "is_default_free": False,
    ...
    {
        "id": "nurse-bee",
        "product_id": "beesmart.avatar.nurse_bee",
        "name": "Nurse Bee Avatar",
        "folder": "glb_files",
        "obj_file": "NurseBee.glb",
        "mtl_file": "",
        "texture_file": "",
        "description": "Caring, kind, and always helpful — Nurse Bee cheers you on to stay healthy and keep spelling strong!",
        "variants": ["default"],
        "category": "classic",
        "tier": "premium",
        "is_default_free": False,
    ...
    {
        "id": "plumber-bee",
        "product_id": "beesmart.avatar.plumber_bee",
        "name": "Plumber Bee Avatar",
        "folder": "glb_files",
        "obj_file": "PlumberBee.glb",
        "mtl_file": "",
        "texture_file": "",
        "description": "Fixing leaks and spelling streaks! Plumber Bee is ready to unclog tricky words.",
        "variants": ["default"],
        "category": "classic",
        "tier": "premium",
        "is_default_free": False,
    ...
    {
        "id": "techno-bee",
        "product_id": "beesmart.avatar.techno_bee",
        "name": "Techno Bee Avatar",
        "folder": "glb_files",
        "obj_file": "TechnoBee.glb",
        "mtl_file": "",
        "texture_file": "",
        "description": "Glowing neon armor and futuristic style — Techno Bee is powered by pure brain energy!",
        "variants": ["default"],
        "category": "fantasy",
        "tier": "premium",
        "is_default_free": False,
    ...
    {
        "id": "umpire-bee",
        "product_id": "beesmart.avatar.umpire_bee",
        "name": "Umpire Bee Avatar",
        "folder": "glb_files",
        "obj_file": "UmpireBee.glb",
        "mtl_file": "",
        "texture_file": "",
        "description": "\"You're SAFE!\" Umpire Bee calls the plays and keeps every spelling game fair and fun.",
        "variants": ["default"],
        "category": "adventure",
        "tier": "premium",
        "is_default_free": False,
    ...
    {
        "id": "xray-bee",
        "product_id": "beesmart.avatar.xray_bee",
        "name": "Xray Bee Avatar",
        "folder": "glb_files",
        "obj_file": "XrayBee.glb",
        "mtl_file": "",
        "texture_file": "",
        "description": "Glowing bones and a bright smile — X-Ray Bee lights up the night with learning power!",
        "variants": ["default"],
        "category": "fantasy",
        "tier": "premium",
        "is_default_free": False,
    ...
    {
        "id": "yeti-bee",
        "product_id": "beesmart.avatar.yeti_bee",
        "name": "Yeti Bee Avatar",
        "folder": "glb_files",
        "obj_file": "YetiBee.glb",
        "mtl_file": "",
        "texture_file": "",
        "description": "Chilly, fluffy, and super friendly — Yeti Bee brings cool fun to your BeeSmart adventure!",
        "variants": ["default"],
        "category": "fantasy",
        "tier": "premium",
        "is_default_free": False,
